...
（本 fork 已併入上游，僅留修訂列表以備查證）

~~本 fork 為[原始版](https://github.com/ayaka14732/rime-tupa)之修改，加入了[仍在討論中的一些審音修訂](https://github.com/ayaka14732/rime-tshet/discussions/2)，以及其他一些尚未整合進上游數據、可能仍需討論的修訂：~~

- 上游單字碼表「徯」小韻誤作「曉開齊上」，本版修正為「匣開齊上」
- 本版引入了若干 Qieyun.js 未來提案中的邊緣地位修訂：
  - 「憶」小韻（影開蒸入）中「抑」等字依《切韻》相關版本分拆為「職韻B類」
  - 「孑」小韻（上游碼表為「見開B仙入」、qieyun-data 為「見開A仙入」）「孑」等字與「揭」等字拆分為重紐兩類
  - 「𠁫/恘」小韻（溪尤平，與「丘」小韻重出）依《切韻》相關版本修訂為「幽韻B類」
  - 「箉」小韻（羣開佳上）「箉」字修訂為「定開佳上」，「拐」字移出併入「見合佳上」音
- 上游詞語碼表「這」用了「疑開B仙去」的無關音，本版依《康熙字典》所記「者」音修訂為「章開三麻上」
- 「拼」字
  - 上游單字碼表比韻書增收「滂青平」的音，此為「拼命」之「拼」，本版增收「拼合」義的另一音（音同「并」平聲）
  - 上游詞語碼表「拼」用了「幫耕平」的無關音，本版依具體詞調整為後起兩音
