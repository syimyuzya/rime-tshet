...
- 本版引入了若干 Qieyun.js 未來提案中的邊緣地位修訂：
  ...
  - 「孑」小韻（上遊碼表為「見開B仙入」、qieyun-data 為「見開A仙入」）「孑」等字與「揭」等字拆分為重紐兩類
  - 「箉」小韻（羣開佳上）「箉」字修訂為「定開佳上」，「拐」字移出併入「見合佳上」音
- 上遊詞語碼表「這」用了「疑開B仙去」的無關音，本版依《康熙字典》所記「者」音修訂為「章開三麻上」
- 「拼」字
  - 上遊單字碼表比韻書增收「滂青平」的音，此為「拼命」之「拼」，本版增收「拼合」義的另一音（音同「并」平聲）
  - 上遊詞語碼表「拼」用了「幫耕平」的無關音，本版依具體詞調整為後起兩音
